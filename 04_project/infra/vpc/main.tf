...
resource "aws_subnet" "aws05-public-subnet-2a" {
...
resource "aws_subnet" "aws05-private-subnet-2a" {
  vpc_id            = aws_vpc.aws05-vpc.id
...
resource "aws_subnet" "aws05-public-subnet-2c" {
  vpc_id            = aws_vpc.aws05-vpc.id
...
resource "aws_subnet" "aws05-private-subnet-2c" {
  vpc_id            = aws_vpc.aws05-vpc.id
